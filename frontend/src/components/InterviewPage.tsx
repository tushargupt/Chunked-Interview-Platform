...
// export default function InterviewPage({ interviewId }: InterviewPageProps) {
...
//         if (recordingData.interviewId === interviewId && recordingData.isRecording) {
...
//                 Interview ID: <code className="bg-gray-100 px-2 py-1 rounded text-xs">{interviewId}</code>
//               </p>
//             </div>
...
//                   <p>It looks like you may have accidentally navigated away during a previous recording. The recording may have been automatically saved. Please check your recordings list or start a new recording.</p>
//                 </div>
